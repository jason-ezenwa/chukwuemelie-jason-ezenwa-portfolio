        ...
        <section
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              <p className="text-[16px] sm:text-[18px]">{`I am a Full Stack Software Engineer with two over years of experience. Specialized in backend development and frontend development, experienced in system design, DevOps and database management.`}</p>
              <p className="text-[16px] sm:text-[18px]">{`I have a track record of architecting, developing and deploying highly efficient software, enhancing data visualization, and elevating online visibility through effective SEO. My work has delivered high-quality software solutions used by thousands across the blue collar, fintech, lifestyle, and transportation sectors while working at LaborHack, Wynk Nigeria and TruckDispatch.`}</p>
